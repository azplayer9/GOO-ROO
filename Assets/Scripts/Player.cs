...
public class Player : MonoBehaviour {
    ...
    void FixedUpdate() {
        ...
        if (!jumping){
            ...
            if (Input.GetMouseButton(1) && !this.jumpCancel) {
            ...
            this.rig.AddForce( new Vector2(axis * 0.5f, 0), ForceMode2D.Force ); // slight directional influence direction
        ...
        if (Input.GetMouseButtonUp(1)) {
            ...
            if(this.jumpPower > 10 && SpawnBlob()){ // some soft lower bound to ensure the user cannot/does not short jump
